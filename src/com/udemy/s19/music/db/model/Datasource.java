package com.udemy.s19.music.db.model;
...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:E:\\Java udemy\\inteliJ_IDEA_projects\\S19_Databases\\Music\\" + DB_NAME;
    ...
    //a method that returns which artist recorded a particular song. We want to return the artist's name, the album name and the track number for the song of the album.
    ...
    //method for querying song info view with prepared statement
...
//    //method for querying song info view
//    public List<SongArtist> querySongInfoView(String title) {
...
//    // count function query with assigned names (AS) with min
//    public int getCount(String table) {
